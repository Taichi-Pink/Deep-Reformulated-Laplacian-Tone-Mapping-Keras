This is the implementation for [Deep Reformulated Laplacian Tone Mapping](https://arxiv.org/abs/2102.00348). And code here is a replicate by Keras of [our previous code by Tensorflow](https://github.com/linmc86/Deep-Reformulated-Laplacian-Tone-Mapping).
